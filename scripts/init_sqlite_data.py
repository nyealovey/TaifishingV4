    ...
    try:
        ...
        users_data = [
            (
                1,
                "admin",
                "$2b$12$DKFZJIArZQ0ASgxpcGyrHeAXYTBS0ThJjewzso1BnQQm7UWdomcAu",
                "admin",
                "2025-09-12 00:25:19.014781",
                None,
                True,
            ),
            (
                2,
                "jinxj",
                "$2b$12$MFRYxABcpq2UCv1aC22KLuZ88TO0ICM53jIunXNz5C.L7IaOm.Ca.",
                "user",
                "2025-09-12 04:55:11.168860",
                None,
                True,
            ),
        ]
        ...
        db_types_data = [
            (
                ...
                "fa-database",
                "primary",
                '["replication", "partitioning", "json"]',
                True,
                True,
                1,
                "2025-09-12 02:02:33.898448",
                "2025-09-12 03:02:58.406875",
            ),
            (
                2,
                "postgresql",
                ...
                "fa-database",
                "info",
                '["jsonb", "arrays", "full_text_search"]',
                True,
                True,
                2,
                "2025-09-12 02:02:33.899255",
                "2025-09-12 03:06:59.898296",
            ),
            (
                3,
                "sqlserver",
                ...
                "fa-database",
                "danger",
                '["clustering", "mirroring", "always_on"]',
                True,
                True,
                3,
                "2025-09-12 02:02:33.899542",
                "2025-09-12 03:08:49.557828",
            ),
            (
                4,
                "oracle",
                ...
                True,
                4,
                "2025-09-12 02:02:33.899757",
                "2025-09-12 03:02:58.407992",
            ),
        ]
        ...
        classifications_data = [
            (
                2,
                "敏感账户",
                "可授权特定权限以满足业务需求，同时需严格安全控制",
                "high",
                "#fd7e14",
                80,
                True,
                True,
                "2025-09-12 00:44:16.876132",
                "2025-09-12 05:28:53.681826",
            ),
            (
                4,
                "风险账户",
                "可用于删除库和表的操作，需特别监控以防止误删或恶意行为",
                "medium",
                "#bf17fd",
                70,
                True,
                True,
                "2025-09-12 00:44:16.876198",
                "2025-09-12 05:27:36.043494",
            ),
            (
                5,
                "只读用户",
                ...
                True,
                True,
                "2025-09-12 00:44:16.876219",
                "2025-09-12 05:29:01.826658",
            ),
            (
                7,
                "特权账户",
                "用于具有高级权限的管理员或系统账户，负责管理数据库核心操作",
                "critical",
                "#dc3545",
                90,
                True,
                True,
                "2025-09-12 00:44:16.876259",
                "2025-09-12 05:26:04.919677",
            ),
            (
                8,
                "普通账户",
                "用于日常操作的普通用户账户，权限范围有限",
                "low",
                "#3c49fb",
                60,
                True,
                True,
                "2025-09-12 00:44:16.876276",
                "2025-09-12 05:27:45.250653",
            ),
        ]
        ...
        rules_data = [
            (
                ...
                "oracle",
                "oracle_super_rule",
                '{"type": "oracle_permissions", "roles": ["DBA"], "system_privileges": [], "tablespace_privileges": [], "tablespace_quotas": [], "operator": "OR"}',
                True,
                "2025-09-12 00:44:16.879297",
                "2025-09-12 06:08:14.494067",
            ),
            (
                4,
                4,
                "postgresql",
                "postgresql_grant_rule",
                '{"type": "postgresql_permissions", "role_attributes": ["CREATEROLE"], "database_privileges": [], "tablespace_privileges": [], "operator": "OR"}',
                True,
                "2025-09-12 00:44:16.879795",
                "2025-09-12 06:03:24.239989",
            ),
            (
                5,
                7,
                "mysql",
                "mysql_super_rule",
                '{"type": "mysql_permissions", "global_privileges": ["SUPER"], "database_privileges": [], "operator": "OR"}',
                True,
                "2025-09-12 00:44:16.880022",
                "2025-09-12 05:31:38.194297",
            ),
            (
                7,
                7,
                "sqlserver",
                "sqlserver_super_rule",
                '{"type": "sqlserver_permissions", "server_roles": ["sysadmin"], "server_permissions": [], "database_roles": [], "database_privileges": [], "operator": "OR"}',
                True,
                "2025-09-12 00:44:16.880470",
                "2025-09-12 05:39:51.998024",
            ),
            (
                8,
                2,
                "sqlserver",
                "sqlserver_grant_rule",
                '{"type": "sqlserver_permissions", "server_roles": ["securityadmin"], "server_permissions": [], "database_roles": [], "database_privileges": [], "operator": "OR"}',
                True,
                "2025-09-12 00:44:16.880657",
                "2025-09-12 06:00:46.901211",
            ),
            (
                9,
                2,
                "mysql",
                "mysql_grant_rule",
                '{"type": "mysql_permissions", "global_privileges": ["GRANT OPTION"], "database_privileges": [], "operator": "OR"}',
                True,
                "2025-09-12 05:34:11.813260",
                "2025-09-12 05:34:11.813269",
            ),
            (
                10,
                4,
                "mysql",
                "mysql_delete_rule",
                '{"type": "mysql_permissions", "global_privileges": ["DROP"], "database_privileges": ["DROP"], "operator": "OR"}',
                True,
                "2025-09-12 05:34:53.465284",
                "2025-09-12 05:34:53.465291",
            ),
            (
                11,
                4,
                "sqlserver",
                "sqlserver_delete_rule",
                '{"type": "sqlserver_permissions", "server_roles": [], "server_permissions": ["ALTER ANY DATABASE"], "database_roles": ["db_owner"], "database_privileges": ["DELETE"], "operator": "OR"}',
                True,
                "2025-09-12 06:01:31.340355",
                "2025-09-12 06:01:31.340362",
            ),
            (
                12,
                7,
                "postgresql",
                "postgresql_super_rule",
                '{"type": "postgresql_permissions", "role_attributes": ["SUPERUSER"], "database_privileges": [], "tablespace_privileges": [], "permissions": ["SUPERUSER"], "operator": "OR"}',
                True,
                "2025-09-12 06:03:41.681866",
                "2025-09-12 06:03:41.681870",
            ),
        ]
...
def sync_mysql_accounts(instance, config):
    ...
    return result''',
                ...
                0,
                0,
                "2025-09-12 01:20:05.772007",
                "2025-09-12 01:20:05.772013",
            )
        ]
