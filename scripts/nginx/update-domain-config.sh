...
echo "  - dbinfo.chint.com (HTTP -> HTTPS 重定向)"
echo "  - *.chint.com (HTTP -> HTTPS 重定向)"
...
echo "  - HTTP 端口: 80"
echo "  - HTTPS 端口: 443"
echo "  - 支持的域名: localhost, dbinfo.chint.com, *.chint.com"
...
echo "  - 域名访问: https://dbinfo.chint.com"
echo "  - 通配符域名: https://任意.chint.com"
...
echo "  - dbinfo 访问日志: /var/log/nginx/dbinfo_access.log"
