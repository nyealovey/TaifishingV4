...
class Pagination:
    ...
    def validate_per_page(per_page: int) -> int:
        ...
        return max(
            ...
            min(per_page, Pagination.MAX_PER_PAGE)
        )

# 导出所有常量
__all__ = [
    'LogLevel', 'LogType', 'UserRole', 'TaskStatus', 'InstanceStatus',
    'DatabaseType', 'TaskType', 'SystemConstants', 'DefaultConfig',
    'ErrorMessages', 'SuccessMessages', 'RegexPatterns', 'DangerousPatterns',
    'FieldLengths', 'CacheKeys', 'TimeFormats', 'Pagination'
]
