...
class QueryBuilder:
    ...
    @staticmethod
    def build_user_query(filters: Dict[str, Any] = None, 
                        order_by: str = None, 
                        limit: int = None,
                        offset: int = None):
        """构建用户查询"""
    ...
    @staticmethod
    def build_instance_query(filters: Dict[str, Any] = None,
                           order_by: str = None,
                           limit: int = None,
                           offset: int = None):
        """构建实例查询"""
        ...
        if filters:
            ...
            if 'search' in filters and filters['search']:
                ...
                query = query.filter(
                    or_(
                        Instance.name.like(search_term),
                        Instance.host.like(search_term)
                    )
                )
    ...
    @staticmethod
    def build_log_query(filters: Dict[str, Any] = None,
                       order_by: str = None,
                       limit: int = None,
                       offset: int = None):
        """构建日志查询"""
...
class BatchOperations:
    ...
    @staticmethod
    def bulk_update(model_class, data_list: List[Dict[str, Any]], 
