...
class RateLimiter:
    ...
    def _check_redis(self, identifier: str, endpoint: str, limit: int, window: int, 
                    current_time: int, window_start: int) -> Dict[str, any]:
        """使用Redis检查速率限制"""
    ...
    def _check_memory(self, identifier: str, endpoint: str, limit: int, window: int,
                     current_time: int, window_start: int) -> Dict[str, any]:
        """使用内存检查速率限制"""
