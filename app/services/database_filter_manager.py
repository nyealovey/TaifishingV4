...
class DatabaseFilterManager:
    ...
    def _load_filter_rules(self) -> Dict[str, Dict[str, Any]]:
        ...
        default_rules = {
            ...
            'oracle': {
                'exclude_users': [
                    'SCOTT', 'CTXSYS', 'EXFSYS', 'MDDATA', 'APPQOSSYS', 'OUTLN', 'DIP', 
                    'TSMSYS', 'WMSYS', 'XDB', 'ANONYMOUS', 'ORDPLUGINS', 'ORDSYS', 
                    'SI_INFORMTN_SCHEMA', 'MDSYS', 'OLAPSYS', 'SPATIAL_CSW_ADMIN_USR', 
                    'SPATIAL_WFS_ADMIN_USR', 'APEX_PUBLIC_USER', 'APEX_030200', 
                    'FLOWS_FILES', 'HR', 'OE', 'PM', 'IX', 'SH', 'BI', 'DEMO', 'ADMIN', 
                    'AUDSYS', 'GSMADMIN_INTERNAL', 'GSMCATUSER', 'GSMUSER', 'LBACSYS', 
                    'OJVMSYS', 'ORACLE_OCM', 'ORDDATA', 'ORDPLUGINS', 'ORDS_METADATA', 
                    'ORDS_PUBLIC_USER', 'PDBADMIN', 'RDSADMIN', 'REMOTE_SCHEDULER_AGENT', 
                    'SYSBACKUP', 'SYSDG', 'SYSKM', 'SYSRAC', 'SYS$UMF', 'XS$NULL', 
                    'OWBSYS', 'OWBSYS_AUDIT'
                ],
