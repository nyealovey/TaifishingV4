...
def error_metrics():
    ...
    try:
        ...
        return APIResponse.success(data={"error_metrics": metrics})
...
def get_recent_activities():
    ...
    activities = (
        Log.query.filter(Log.created_at >= since)
...
def get_users():
    ...
    try:
        ...
        return APIResponse.success(data={"users": users, "pagination": pagination_data})
