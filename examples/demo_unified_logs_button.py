...
from app.utils.structlog_config import get_api_logger, get_auth_logger, get_db_logger
...
def demo_unified_logs():
    ...
    with app.app_context():
        ...
        print("\n🎉 演示完成!")
        print("\n📱 现在您可以:")
        print("   1. 访问统一日志中心: http://localhost:5001/logs/")
        print("   2. 查看结构化日志")
        print("   3. 使用筛选器过滤日志")
        print("   4. 导出日志为CSV格式")
        print("   5. 查看日志统计信息")
        ...
        print("\n🔧 API端点:")
        print("   - 查询日志: http://localhost:5001/logs/api/structlog/search")
        print("   - 获取统计: http://localhost:5001/logs/api/structlog/stats")
        print("   - 获取模块: http://localhost:5001/logs/api/structlog/modules")
        print("   - 导出日志: http://localhost:5001/logs/api/structlog/export")
