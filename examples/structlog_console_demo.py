...
def demo_context_binding():
    ...
    # 绑定全局上下文
    bind_context(operation_id="op_001", session_id="sess_123456", feature="user_management", environment="development")
...
def demo_error_tracking():
    ...
    try:
        ...
        logger.error("除零错误", module="error_demo", operation="division", dividend=10, divisor=0, exception=str(e))
